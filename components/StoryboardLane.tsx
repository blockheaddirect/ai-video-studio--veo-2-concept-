...
interface StoryboardLaneProps {
  ...
  onMoveItem: (itemId: string, direction: 'up' | 'down') => void; // Simplified for now
}
...
export const StoryboardLane: React.FC<StoryboardLaneProps> = ({
  ...
  return (
    <div className="bg-surface p-3 rounded-lg h-40 overflow-x-auto whitespace-nowrap flex space-x-3">
